...
<head>
	...
	<title>Career Advice Consultaion</title>
  ...
  line-height: 1.6;
    ...
    .logo {
      width: 40px; /* Adjust the size of your logo as needed */
      height: 40px;
      margin-right: 8px;
    }
...
<body>
	...
	<div class="limiter">
	<div class="title-bar">
    <img class="logo" src="login-ui/images/UCS-removebg-preview.png" alt="Logo">
    <div class="title">Urbiztondo Catholic School</div>
		...
		<div class="container-login100"  style="background-image: url(login-ui/images/ucs1.jpg	); background-repeat: no-repeat; background-position: center; background-size: cover;">
			<div class="wrap-login100">
				...
				<form method="post" id="examineeLoginFrm" class="login100-form ">
